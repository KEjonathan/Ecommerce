        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white pt-4 pb-3 border-0">
                    <h3 class="text-center fw-bold">{{ __('Create Account') }}</h3>
                    <p class="text-center text-muted mb-0">Fill in your details to get started</p>
                </div>
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="text-center">
                            <p class="mb-0">{{ __('Already have an account?') }} <a href="{{ route('login') }}" class="text-decoration-none fw-medium">{{ __('Login') }}</a></p>
                        </div>
                    </form>
                </div>
            </div>
